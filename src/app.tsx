          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-5">
            ...
            {isGuestsInputOpen ? (
              <button
                ...
                className="bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center justify-center gap-2 hover:bg-zinc-700"
              >
                {' '}
                Alterar local/data
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <form onSubmit={addNewEmailToInvite} className="space-y-3">
              ...
              <button
                type="submit"
                className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center justify-center gap-2 hover:bg-lime-400 w-full h-11"
              >
                Confirmar criação da viagem
                <Plus className="size-5" />
              </button>
