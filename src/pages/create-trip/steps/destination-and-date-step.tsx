...
export function DestinationAndDateStep({
  ...
  const [isDatePickerOpen, setIsDatePickekOpen] = useState(false)

  function openDatePicker() {
    return setIsDatePickekOpen(true)
  }
  function closeDatePicker() {
    return setIsDatePickekOpen(false)
  }
  ...
  return (
    <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-5">
      ...
      >
        ...
        <span className=" text-left text-lg text-zinc-400 w-40 flex-1">
